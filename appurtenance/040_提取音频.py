...
#	os.system("ffmpeg -i /Users/yupengqin/Desktop/sd1551072138_2.MP4  -r 10 -f image2 /Users/yupengqin/Desktop/Video/%05d.png")
	if os.path.isfile(videoLocation+"/VideoToSound.mp3"):
		os.remove(videoLocation+"/VideoToSound.mp3")
	#10一秒10帧 png可以切换的图片格式
	os.system("ffmpeg -i "+videoLocation+" -f mp3 -vn "+mypath+"/VideoToSound.mp3")
