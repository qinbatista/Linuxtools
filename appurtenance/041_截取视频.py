...
#	os.system("ffmpeg -i /Users/yupengqin/Desktop/sd1551072138_2.MP4  -r 10 -f image2 /Users/yupengqin/Desktop/Video/%05d.png")
	if os.path.isfile(videoLocation+"/VideoToPicture_Cut.mp4"):
		os.remove(videoLocation+"/VideoToPicture_Cut.mp4")
	#10一秒10帧 png可以切换的图片格式
	start="00:00:16"
	duration ="00:00:16"
	os.system("ffmpeg -ss "+start+" -t "+duration+" -i "+videoLocation+" -c:v libx264 -c:a aac -strict experimental -b:a 98k "+mypath+"/VideoToPicture_Cut.mp4")
